...
else{this.carousel.reloadSlider(this._getSettings());}},};})(jQuery);(function($){$(function(){new FLBuilderPostCarousel({id:'5989e22bf0d5b',layout:'grid',navigationControls:true,slideWidth:420,settings:{pager:false,auto:true,pause:10000,speed:1000,autoDirection:'next',infiniteLoop:false,adaptiveHeight:true,controls:false,autoHover:true,slideMargin:30,moveSlides:1,onSlideBefore:function(ele,oldIndex,newIndex){$('.fl-node-5989e22bf0d5b .fl-post-carousel-navigation a').addClass('disabled');$('.fl-node-5989e22bf0d5b .bx-controls .bx-pager-link').addClass('disabled');},onSlideAfter:function(ele,oldIndex,newIndex){$('.fl-node-5989e22bf0d5b .fl-post-carousel-navigation a').removeClass('disabled');$('.fl-node-5989e22bf0d5b .bx-controls .bx-pager-link').removeClass('disabled');}}});});})(jQuery);(function($){$(function(){new FLBuilderPostCarousel({id:'59cb927d01938',layout:'grid',navigationControls:true,slideWidth:420,settings:{pager:false,auto:true,pause:10000,speed:1000,autoDirection:'next',infiniteLoop:false,adaptiveHeight:true,controls:false,autoHover:true,slideMargin:30,moveSlides:1,onSlideBefore:function(ele,oldIndex,newIndex){$('.fl-node-59cb927d01938 .fl-post-carousel-navigation a').addClass('disabled');$('.fl-node-59cb927d01938 .bx-controls .bx-pager-link').addClass('disabled');},onSlideAfter:function(ele,oldIndex,newIndex){$('.fl-node-59cb927d01938 .fl-post-carousel-navigation a').removeClass('disabled');$('.fl-node-59cb927d01938 .bx-controls .bx-pager-link').removeClass('disabled');}}});});})(jQuery);(function($){$(function(){$('.fl-embed-video').fitVids();if(($('.fl-module-video .fl-wp-video video').length>1)&&typeof $.fn.mediaelementplayer!=='undefined'){$('.fl-module-video .fl-wp-video video').mediaelementplayer({pauseOtherPlayers:false});}});FLBuilderVideo=function(settings){this.nodeID=settings.id;this.nodeClass='.fl-node-'+settings.id;this.wrapperClass=this.nodeClass+' .fl-video';this._initVideo();this._initStickyOnScroll();};FLBuilderVideo.prototype={_initVideo:function(){var origTop=$(this.nodeClass).offset().top,origLeft=$(this.nodeClass).offset().left,origHeight=$(this.nodeClass).outerHeight(),origWidth=$(this.nodeClass).outerWidth();$(this.nodeClass).attr('data-orig-top',origTop);$(this.nodeClass).attr('data-orig-left',origLeft);$(this.nodeClass).attr('data-orig-height',origHeight);$(this.nodeClass).attr('data-orig-width',origWidth);},_makeSticky:function(){var origLeft=$(this.nodeClass).data('orig-left'),origHeight=$(this.nodeClass).data('orig-height'),origWidth=$(this.nodeClass).data('orig-width');$(this.nodeClass).addClass('fl-video-sticky');$(this.nodeClass).css('left',origLeft);$(this.nodeClass).css('height',origHeight);$(this.nodeClass).css('width',origWidth);},_removeSticky:function(){$(this.nodeClass).removeClass('fl-video-sticky');},_initStickyOnScroll:function(){$(window).on('scroll',$.proxy(function(e){var win=$(window),winTop=win.scrollTop(),nodeTop=$(this.nodeClass).data('orig-top');isSticky=$(this.nodeClass).hasClass('fl-video-sticky');if(winTop>=nodeTop){if(!isSticky){this._makeSticky();}}else{this._removeSticky();}},this));},};})(jQuery);(function($){})(jQuery);