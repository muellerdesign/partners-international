...
else{this.carousel.reloadSlider(this._getSettings());}},};})(jQuery);(function($){$(function(){new FLBuilderPostCarousel({id:'56959cf0f2293',layout:'grid',navigationControls:true,slideWidth:420,settings:{pager:false,auto:true,pause:10000,speed:1000,autoDirection:'next',infiniteLoop:false,adaptiveHeight:true,controls:false,autoHover:true,slideMargin:30,moveSlides:1,onSlideBefore:function(ele,oldIndex,newIndex){$('.fl-node-56959cf0f2293 .fl-post-carousel-navigation a').addClass('disabled');$('.fl-node-56959cf0f2293 .bx-controls .bx-pager-link').addClass('disabled');},onSlideAfter:function(ele,oldIndex,newIndex){$('.fl-node-56959cf0f2293 .fl-post-carousel-navigation a').removeClass('disabled');$('.fl-node-56959cf0f2293 .bx-controls .bx-pager-link').removeClass('disabled');}}});});})(jQuery);(function($){$(function(){new FLBuilderPostCarousel({id:'59778169263b2',layout:'grid',navigationControls:true,slideWidth:420,settings:{pager:false,auto:true,pause:10000,speed:1000,autoDirection:'next',infiniteLoop:false,adaptiveHeight:true,controls:false,autoHover:true,slideMargin:30,moveSlides:1,onSlideBefore:function(ele,oldIndex,newIndex){$('.fl-node-59778169263b2 .fl-post-carousel-navigation a').addClass('disabled');$('.fl-node-59778169263b2 .bx-controls .bx-pager-link').addClass('disabled');},onSlideAfter:function(ele,oldIndex,newIndex){$('.fl-node-59778169263b2 .fl-post-carousel-navigation a').removeClass('disabled');$('.fl-node-59778169263b2 .bx-controls .bx-pager-link').removeClass('disabled');}}});});})(jQuery);